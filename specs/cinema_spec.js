...
describe('Cinema', function () {
  ...
  it('should be able to get a list of film titles', function() {
    const film_titles = cinema.filmTitles()
    assert.deepStrictEqual(film_titles, ['Moonlight','Blade Runner 2049', 'Dunkirk', 'Black Panther', 'T2 Trainspotting'])
  });
  ...
  it('should be able to check whether there are some films from a particular year', function(){
    const actual = cinema.containsFilmsByYear(2017);
    assert.deepStrictEqual(actual, true);
  });
  it('should be able to check whether there are no films from a particular year', function(){
    const actual = cinema.containsFilmsByYear(1926);
    assert.deepStrictEqual(actual, false);
  });
  it('should be able to check whether all films are over a particular length', function(){
    const actual = cinema.areAllFilmsOfMinLength(96);
    assert.deepStrictEqual(actual, true);
  });
  ...
  it('should be able to find films by property and value', function(){
